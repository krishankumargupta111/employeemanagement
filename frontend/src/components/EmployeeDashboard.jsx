...

        {
        ...
        },
         {
            ...
            value:data.latestPayslip ?
             `$${data.latestPayslip.netSalary?.toLocaleString()}`:"N/A",
...
text-slate-600 group-hover:bg-indigo-600 transition-colors
duration-200"/>
</div>
))}
      </div>
...
<div className='flex flex-col sm:flex-row gap-3'>
    <Link to="/attendence" className='btn-primary text-center
