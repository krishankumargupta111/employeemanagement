 ...
 hover:text-white p-1'>
      ...
      <div className='flex-1 px-3 space-y-0.5 overflow-y-auto'>
        {loading ?(
          ...
          text-slate-500'>
            <Loader2Icon className='animate-apin w-4 h-4'/>
    ...
    text-[13px] font-medium transition-all duration-150 relative
     ${isActive ? "bg-indigo-500/12 text-indigo-300" :
              ...
              {isActive && <div className='absolute left-0 top-1/2 -translate-y-1/2
...
duration-150'>
  ...
  return (
    ...
    text-white shrink-0 border-r border-white/4'>
      ...
      bg-linear-to-b from-slate-900 via-slate-900 to-slate-950
      text-white z-50 flex flex-col transform transition-transform
