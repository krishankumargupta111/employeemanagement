...
toast.error(err.response?.data?.error || err?.message)
  ...
  return (
    ...
    p-4 bg-black/40 backdrop-blur-sm ' onClick={onClose}>
      ...
      max-w-lg animate-fade-in' onClick={(e)=>e.stopPropagation()}>
...
text-slate-400 hover:text-slate-600'>
  <X className='w-5 h-5'/>
      ...
      <form onSubmit={handleSubmit} className='p-6 sapce-y-5'>
        <div>
        ...
        <div>
          ...
          font-medium text-slate-700 mb-2 block'>
            Reason
          </label>
...
<button disabled={loading}
 type="submit" className='btn-primary flex-1 flex items-center
