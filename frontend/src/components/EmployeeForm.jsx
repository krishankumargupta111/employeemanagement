...
<div className='card p-5 sm:p-6'>
    ...
    pb-4 border-b border-slate-100 '>Employment Details</h3>
...
text-slate-700'>
  ...
  <div>
         ...
         <div>
            ...
            <input text="number" name="basicSalary" required 
            min="0" step="0.01"
...
gap-3 pt-2'>
    ...
    justify-center'>
       ...
       animate-spin'/>}
       {isEditMode ?"Update Empolyee":'Create Employee'}
    </button>
