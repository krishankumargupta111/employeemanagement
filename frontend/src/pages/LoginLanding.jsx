  ...
  const portalOptions=[
    {
      to:"/login/admin",
      title:"Admin Portal",
      description:"Manage employess,depatments,payroll and system configuation",
      icon:ShieldIcon
    },
...
<div className='w-full max-w-md animate-fade-in relative z-10'>
  <div className='mb-10 trxt-center md:text-left'>
...
<Link key={portal.to} to={portal.to} className="group 
block bg-slate-50 border border-slate-200 rounded-lg p-5
sm:p-6 transition-all duration-300
hover:border-indigo-400 hover:bg-indigo-50">

<div className='relaitve z-10 flex items-center justify-between gsp-4
sm:gap-5'>
